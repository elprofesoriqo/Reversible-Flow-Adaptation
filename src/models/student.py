...
from src.models.components import VisionEncoder, UNet1D
...
class StudentPolicy(nn.Module):
    ...
    @nn.compact
    def __call__(self, proprio_obs: jax.Array, vision_obs: jax.Array, noisy_actions: jax.Array, time_steps: jax.Array) -> Tuple[jax.Array, jax.Array]:
        vision_features = VisionEncoder()(vision_obs)
        
        # Auxiliary Head: Predict privileged state from vision
        ...
        return vector_field_pred, priv_pred
